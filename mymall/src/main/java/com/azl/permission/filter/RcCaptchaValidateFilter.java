package com.azl.permission.filter;
...
public class RcCaptchaValidateFilter extends AccessControlFilter {
	...
	private String captchaParam = "verifyCode";// 前台提交的验证码参数名
	...
	protected boolean isAccessAllowed(ServletRequest request, ServletResponse response, Object mappedValue) throws Exception {
		...
		// 获取session中的验证码
		String captcha = (String) httpServletRequest.getSession().getAttribute("verifyCode");
		// 若验证码为空或匹配失败则返回false
        if(submitCaptcha == null) {
            return false;
        }
