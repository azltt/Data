...
<body>
			...
			<nav class="nav menu">
				<div class="drow-menu">
					<ul class="menu-ul">
						...
						<li><a href="${pageContext.request.contextPath}/item/list">商城</a></li>
		...
		<div class="storeAll">
			<div class="store1Con">
				<div class="store1Part store1Part1">
					<a href="${pageContext.request.contextPath}/classify"> <span
						class=""></span>
						<h2>手机</h2>
					</a>
				</div>
	...
	<div class="store1Nav">
		...
		<a href="#" class="store1NavTwo"><span
			class="glyphicon glyphicon-menu-down"></span></a>
	</div>


	<div class="store2">
		<span class="store4Pic"> <a class="store4Big" href="#"></a> <a
			class="store4Small" href="#"> <img
				src="${pageContext.request.contextPath}/img/store3.2.1.small.jpg" />
		</a>
		</span>
	</div>
	...
	<div class="storeAll">
		<div class="store3">
			...
			<div class="store3Part">
				<a href="#"> <img
					src="${pageContext.request.contextPath}/img/store3.3.1.jpg" />
				</a>
			</div>
			<div class="store3Part">
				<a href="#"> <img
					src="${pageContext.request.contextPath}/img/store3.3.2.jpg" />
				</a>
			</div>
			<div class="store3Part">
				<a href="#"> <img
					src="${pageContext.request.contextPath}/img/store3.3.3.jpg" />
				</a>
			</div>
			<div class="clearfix"></div>
			<!--撑开外面的div，高度自适应-->
		...
		<div class="storeAll">
			<div class="store4One">
				...
				<div class="store4Part">
						<a href="#"> <img
							src="${pageContext.request.contextPath}/img/store3.4.1.png" />
							<h2>${i.title}</h2> <span>¥&nbsp;${i.price }</span>
						</a>
					</div>
			</c:forEach>
					<div class="store4Part">
						<a href="#"> <img
							src="${pageContext.request.contextPath}/img/store3.4.1.png" />
							<h2>OnePlus 5 个性保护壳</h2> <span>¥&nbsp;99</span>
						</a>
					</div>
					<div class="store4Part">
						<a href="#"> <img
							src="${pageContext.request.contextPath}/img/store3.4.2.png" />
							<h2>一加银耳 2</h2> <span>¥&nbsp;99</span>
						</a>
					</div>
					<div class="store4Part">
						<a href="#"> <img
							src="${pageContext.request.contextPath}/img/store3.4.3.png" />
							<h2>一加车载闪充</h2> <span>¥&nbsp;99</span>
						</a>
					</div>
					<div class="store4Part">
						<a href="#"> <img
							src="${pageContext.request.contextPath}/img/store3.4.4.png" />
							<h2>OnePlus 5 芳纶纤维全包保护壳</h2> <span>¥&nbsp;99</span>
						</a>
					</div>
					<div class="clearfix"></div>
				</div>
			...
			<div class="store4Two">
				...
				<div class="store4Con">
					<div class="store4Part">
						<a href="#"> <img
							src="${pageContext.request.contextPath}/img/store3.4.5.png" />
							<h2>一加旅行双肩包</h2> <span>¥&nbsp;99</span>
						</a>
					</div>
					<div class="store4Part">
						<a href="#"> <img
							src="${pageContext.request.contextPath}/img/store3.4.6.png" />
							<h2>出行套装</h2> <span>¥&nbsp;99</span>
						</a>
					</div>
					<div class="store4Part">
						<a href="#"> <img
							src="${pageContext.request.contextPath}/img/store3.4.7.png" />
							<h2>一加真皮钱包</h2> <span>¥&nbsp;99</span>
						</a>
					</div>
					<div class="store4Part">
						<a href="#"> <img
							src="${pageContext.request.contextPath}/img/store3.4.8.png" />
							<h2>一加旅行袋</h2> <span>¥&nbsp;99</span>
						</a>
					</div>
					<div class="clearfix"></div>
				</div>
